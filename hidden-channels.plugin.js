 ...
 * @description Stalker Plugin (See hidden Chanels)
 * @source https://github.com/aqexx/hidden-channels
 * @updateUrl https://github.com/aqexx/hidden-channels/hidden-channels.js
 */
...
module.exports = (_ => {
	const config = {
		"info": {
			...
			"author": "Alex",
			"version": "1.0.0",
			"description": "Zeigt alle versteckten channels"
		}
	};
